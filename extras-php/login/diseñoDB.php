...
<body onload="cerrarSesion();">
    ...
    <div><h1 style="text-align: center; font-size: 60px;">DISEÑO DATA BASE</h1><br/><br/><br/>
        <div style="text-align: center;"><h1 style="text-align: center;">Diagrama simple</h1><br/><br/><img src="MER/base.png" alt="Diagrama Simple" width="1200" height="auto"/></div><br/><br/><br/>
        <div style="text-align: center;"><h1 style="text-align: center;">Modelo Conceptual</h1><br/><br/><img src="MER/conceptual.png" alt="Modelo Conceptual" width="1200" height="auto"/></div><br/><br/><br/>
        <div style="text-align: center;"><h1 style="text-align: center;" >Modelo Lógico</h1><br/><br/><img src="MER/logico.PNG" alt="Modelo Logico" width="1200" height="auto"/></div><br/><br/><br/>
        <div style="text-align: center;"><h1 style="text-align: center;">Modelo Físico</h1><br/><br/><img src="MER/fisico.png" alt="Modelo Fisico" width="1200" height="auto"/></div><br/><br/><br/>
    </div>
    <br/><br/><br/><br/>
